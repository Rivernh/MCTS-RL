...
from gym_carla.agent.global_planner import RoadOption,GlobalPlanner
from gym_carla.settings import ROADS, STRAIGHT, CURVE, JUNCTION
from gym_carla.util.misc import get_lane_center, get_speed, vector, compute_magnitude_angle, \
