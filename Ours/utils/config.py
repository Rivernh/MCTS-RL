...
def get_config():
    ...
    Env parameters:
        ...
        --use_obs_instead_of_state
            [only for some env] by default False, will use global obs; or else will use concatenated local obs.
    ...
    parser.add_argument("--use_obs_instead_of_state", action='store_true',
                        default=False, help="Whether to use global obs or concatenated obs")
